...
var proxyRp = rp.defaults({ 'proxy': proxyUrl });
var enable_proxy = (proxyUser !== undefined && proxyPass !== undefined);
var finalRequestPromise = enable_proxy ? proxyRp : rp;
exports.fetchPage = function (url) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = cheerio).load;
                return [4, finalRequestPromise.get({
                        url: url,
                    }).then(function (body) {
                        return body;
                    })];
