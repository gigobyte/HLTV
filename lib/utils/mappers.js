...
exports.mapVetoElementToModel = function (el, team1, team2) {
    ...
    var _b = el.text().replace(/^\d. /, '').split(/was/), lastMap = _b[0], lastType = _b[1];
    if (lastMap && lastType) {
        return {
            team: undefined,
            map: exports.getMapSlug(lastMap.trim()),
            type: 'left'
        };
    }
    return {
...
exports.mapRoundElementToModel = function () { return function (el) {
