...
var getMatch = function (_a) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var $, title, date, format, additionalInfo, live, hasScorebot, teamEls, team1, team2, vetoes, event, maps, players, streams, highlightedPlayerLink, highlightedPlayer, headToHead, highlights;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2, {
                            team1: team1, team2: team2, date: date, format: format, additionalInfo: additionalInfo, event: event, maps: maps, players: players, streams: streams, live: live,
