...
var getMatches = function () { return __awaiter(_this, void 0, void 0, function () {
    var $, liveMatches, upcomingMatches;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, mappers_1.fetchPage(constants_1.HLTV_URL + "/matches")];
            case 1:
                $ = _a.sent();
                ...
                upcomingMatches = mappers_1.toArray($('.upcoming-match')).map(function (matchEl) {
                    ...
                    if (!title) {
                        ...
                        event = {
                            ...
                            id: Number(E.popSlashSource(matchEl.find('img.event-logo')).split('.')[0])
                        };
                    }
